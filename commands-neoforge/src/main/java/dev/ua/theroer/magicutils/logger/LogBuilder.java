...
public class LogBuilder extends LogBuilderCore {
     ...
     *
     * @param players player recipients
     * @return this builder
     */
    ...
    /**
     * Sends the log to a command source.
     *
    ...
    /**
     * Sends the log to a command source with optional op broadcast.
     *
     * @param source command source
    ...
    /**
     * Sends the log to a command source in error mode.
     *
     * @param source command source
     * @return this builder
     */
