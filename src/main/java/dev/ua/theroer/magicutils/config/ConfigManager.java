...
public class ConfigManager {
     ...
     */
    private void writeDefaults(Object instance, YamlConfiguration yaml, Class<?> clazz, String prefix) throws Exception {
                        ...
                        for (Map.Entry<String, Object> entry : map.entrySet()) {
                            if (entry.getValue() instanceof Map) {
                                deserializedMap.put(entry.getKey(), 
                                    ConfigSerializer.deserialize((Map<String, Object>) entry.getValue(), valueType));
                                ...
                                org.bukkit.configuration.ConfigurationSection subSection = (org.bukkit.configuration.ConfigurationSection) entry.getValue();
