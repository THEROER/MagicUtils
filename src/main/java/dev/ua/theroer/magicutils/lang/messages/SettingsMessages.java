...
public class SettingsMessages {
    ...
    public String getMessage(String key) {
        switch (key) {
            case "language_not_initialized": return languageNotInitialized;
            case "invalid_arguments": return invalidArguments;
            case "current_language": return currentLanguage;
            case "available_languages": return availableLanguages;
            case "language_not_found": return languageNotFound;
            case "key_not_found": return keyNotFound;
            case "key_value": return keyValue;
            case "key_set": return keySet;
            default: return null;
        }
    }
}