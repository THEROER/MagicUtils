...
public class SystemMessages {
    ...
    public String getMessage(String key) {
        switch (key) {
            case "loaded_language": return loadedLanguage;
            case "failed_load_language": return failedLoadLanguage;
            case "failed_save_messages": return failedSaveMessages;
            case "created_default_config": return createdDefaultConfig;
            case "section_not_reloadable": return sectionNotReloadable;
            case "command_registered": return commandRegistered;
            case "command_usage": return commandUsage;
            case "subcommand_usages": return subcommandUsages;
            case "alias_registered": return aliasRegistered;
            case "alias_usage": return aliasUsage;
            case "generated_permissions": return generatedPermissions;
            case "unregistered_command": return unregisteredCommand;
            default: return null;
        }
    }
}