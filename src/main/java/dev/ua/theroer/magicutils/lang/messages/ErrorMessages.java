...
public class ErrorMessages {
    ...
    public String getMessage(String key) {
        switch (key) {
            case "message_not_set": return messageNotSet;
            case "failed_get_commandmap": return failedGetCommandMap;
            case "registry_not_initialized": return registryNotInitialized;
            case "commandmap_not_available": return commandMapNotAvailable;
            case "missing_commandinfo": return missingCommandInfo;
            case "missing_configfile": return missingConfigFile;
            case "required_config_missing": return requiredConfigMissing;
            default: return null;
        }
    }
}