 ...
 * formatting support. All log level methods are generated by annotation processor.
 */
@LogMethods
public final class Logger {
    ...
    /**
     * Universal send method for logging messages with complete control over delivery.
     * 
     ...
     * @param broadcast if true, sends to all online players (ignoring player/players params)
     */
