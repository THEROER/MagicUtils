 ...
 */
@ConfigFile("{logger_dir}/logger.{ext}")
...
public class LoggerConfig {
    ...
    @ConfigSection("help")
    @Comment("Help command formatting settings")
    @Getter(AccessLevel.NONE)
    @Setter(AccessLevel.NONE)
    private HelpSettings help = new HelpSettings();
     ...
     *
     * @return copy of help settings
     */
    public HelpSettings getHelp() {
        return copyHelp(help);
    }

    /**
     * Sets help command formatting settings.
     *
     * @param help help settings to copy; null uses defaults
     */
    public void setHelp(HelpSettings help) {
        this.help = copyHelp(help);
    }
    ...
    private HelpSettings copyHelp(HelpSettings source) {
        HelpSettings target = new HelpSettings();
        if (source != null) {
            target.setUseLoggerColors(source.isUseLoggerColors());
            target.setPrimaryColor(source.getPrimaryColor());
            target.setMutedColor(source.getMutedColor());
