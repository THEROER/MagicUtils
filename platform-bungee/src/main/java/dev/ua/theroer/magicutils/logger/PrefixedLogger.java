...
public class PrefixedLogger extends PrefixedLoggerMethods implements PrefixedLoggerAdapter<ProxiedPlayer, LogBuilder> {
    ...
    @Override
    public LoggerAdapter<ProxiedPlayer, ?> getLoggerAdapter() {
        return logger;
    }
    ...
    @Override
    public void send(LogLevel level, Object message, ProxiedPlayer player) {
        PrefixedLoggerAdapter.super.send(level, message, player);
    }

    @Override
    public void send(LogLevel level, Object message, ProxiedPlayer player, boolean all) {
    ...
    @Override
    public void sendToPlayers(LogLevel level, Object message, Collection<? extends ProxiedPlayer> players) {
