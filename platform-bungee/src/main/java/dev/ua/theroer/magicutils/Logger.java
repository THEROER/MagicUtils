...
/**
 * BungeeCord logger adapter backed by {@link LoggerCore}.
 *
 * <p>Gives BungeeCord the same typed logger facade as Bukkit/Fabric/NeoForge:
 * generated {@code info/warn/error/success/debug/trace} methods, player-typed
 * overloads keyed on {@link ProxiedPlayer}, prefixed sub-loggers, and a fluent
