    ...
    magicUtilsOrderedMap(
        ...
        "platforms" to magicUtilsOrderedMap(
                ...
                "version_matrix" to listOf(
                    magicUtilsVersionMatrixEntry(
                        ...
                        gradleProperties = magicUtilsGradleProperties(
                            "javaVersion" to "17",
                            "magicutilsVersion" to "1.19.1-mc1201",
                    ...
                    magicUtilsVersionMatrixEntry(
                        ...
                        versions = listOf("26.1-26.1.1"),
                        smokeValues = listOf("26.1", "26.1.1"),
                        gradleProperties = magicUtilsGradleProperties(
                            "javaVersion" to "25",
                            "magicutilsVersion" to "1.19.1-mc2611",
                            "paperVersion" to "26.1.1.build.29-alpha",
                        ),
                    ),
                ),
            ),
            ...
            "fabric" to magicUtilsOrderedMap(
                "defaults" to magicUtilsDefaults(
                    "magicutilsFabricBundleVersion" to "1.19.1",
